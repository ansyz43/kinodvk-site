...
<section class="content-section">
  <div class="submit-options">
    ...
    <article class="submit-option"><div class="nom-icon">III</div><h3>Форма на сайте</h3><p>Оставьте контакт — мы свяжемся с вами и расскажем, как подать работу, когда приём заявок откроется.</p><button type="button" data-lead-open>Связаться</button></article>
  </div>
